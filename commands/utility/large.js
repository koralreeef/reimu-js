...
module.exports = {
	...
	async execute(interaction) {
        ...
        {
            const attachment = new AttachmentBuilder("https://cdn.discordapp.com/emojis/"+newtext+".gif?quality=lossless");
        ...
        const attachment = new AttachmentBuilder(await canvas.encode('png'), { name: 'emoji.png' });      
        await interaction.reply({ files: [attachment] });
        }
	},
};