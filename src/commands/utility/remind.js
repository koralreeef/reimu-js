...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("remind")
    .setDescription("reminds you with a chosen message in a desired timeframe")
    ...
    .addIntegerOption((option) =>
      option.setName("days").setDescription("days before ping").setMinValue(1),
    )
    .addIntegerOption((option) =>
      option
        .setName("hours")
  ...
  async execute(interaction) {
    ...
    const msg = await interaction.reply(
      "got it! <@" + id + ">, i will remind you <t:" + date + ":R>",
    );
