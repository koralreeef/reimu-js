  ...
  .then(async () => {
    ...
    const pookies = [
      Pookiebears.upsert({
        ...
        creator: "koral",
        creatorURL:
          "https://cdn.discordapp.com/avatars/109299841519099904/588b0dfa2e47bdd3325730eb76bad246.webp",
        summon_count: 0,
        rarity: 0,
      ...
      Pookiebears.upsert({
        ...
        rarity: 0,
        source:
          "[source](https://x.com/danidanihatikyu/status/1450170022563758080)",
      }),
      Pookiebears.upsert({
        id: 4,
